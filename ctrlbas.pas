...
{		(s:$0000; e:$000F; sum:$0700),
		...
		(s:$0020; e:$002F; sum:$3D36),
		(s:$0030; e:$003F; sum:$F1ED),
		(s:$0040; e:$004F; sum:$110B),
		(s:$0050; e:$005F; sum:$3D36),
		(s:$0060; e:$006F; sum:$B1A9),
		(s:$0070; e:$007F; sum:$2924),
		(s:$0080; e:$008F; sum:$776D),
		(s:$0090; e:$009F; sum:$0D09),
		(s:$00A0; e:$00AF; sum:$DFDB),
		(s:$00B0; e:$00BF; sum:$EEE9),
		(s:$00C0; e:$00CF; sum:$5C55),
		(s:$00D0; e:$00DF; sum:$362F),
		(s:$00E0; e:$00EF; sum:$0D07),
		(s:$00F0; e:$00FF; sum:$5852),}
		(s:$0000; e:$00FF; sum:$A85E),

{		(s:$0100; e:$010F; sum:$AAA5),
		(s:$0110; e:$011F; sum:$AEA7),
		(s:$0120; e:$012F; sum:$C0B7),
		(s:$0130; e:$013F; sum:$0602),
		(s:$0140; e:$014F; sum:$726B),
		(s:$0150; e:$015F; sum:$D0CB),
		(s:$0160; e:$016F; sum:$A49F),
		(s:$0170; e:$017F; sum:$C1BB),
		(s:$0180; e:$018F; sum:$7F79),
		(s:$0190; e:$019F; sum:$817C),
		(s:$01A0; e:$01AF; sum:$2419),
		(s:$01B0; e:$01BF; sum:$EBE8),
		(s:$01C0; e:$01CF; sum:$5B58),
		(s:$01D0; e:$01DF; sum:$FFFC),
		(s:$01E0; e:$01EF; sum:$2B27),
		(s:$01F0; e:$01FF; sum:$625D),}
